...
5. [Validation benchmarks](../../measurements/validation-benchmarks/) records the equivalent Kern,
   Zod, and Valibot workloads, exact machine-local results, and reproduction protocol.
6. [Performance internals](../../advanced/performance-internals/) explains Kern's private fast and
