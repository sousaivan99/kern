...
description: Reproduce Lithekit-only array, string, money, object, and Intl scaling measurements.
---

import BenchmarkEnvironments from "../../../components/BenchmarkEnvironments.astro";

This suite measures Lithekit's non-validation modules across small and scaling workloads. It records
...
[primitive benchmark source](https://github.com/sousaivan99/lithekit/blob/develop/tooling/benchmarks/primitives.bench.ts).
