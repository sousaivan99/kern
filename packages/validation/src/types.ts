...
interface LithekitStandardSchemaProps<Input, Output> extends StandardSchemaV1.Props<Input, Output> {
  readonly vendor: "lithekit"
  readonly validate: (
    value: unknown,
...
export interface Schema<Output, Input = Output, Presence extends SchemaPresence = "required">
  ...
  readonly "~standard": LithekitStandardSchemaProps<Input, Output>
}

/** @internal Package-private schema state used by Lithekit's combinators. */
...
export const FAILURE = Symbol("lithekit.validation.failure")
